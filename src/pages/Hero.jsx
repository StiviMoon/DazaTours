    ...
    <>
      <section className="h-[100%] grid grid-cols-1 md:grid-cols-10 ">
        <div className="md:col-span-5 flex items-center justify-center ">
          ...
          <div className="flex flex-col gap-4 p-5 xl:p-10 ">
            <p className="text-azul_o text-lg xl:text-xl m-2 xl:m-5 xl:pt-[355px] pt-[250px] ">
              Descubre la maravilla de Colombia: paisajes impresionantes,
              cultura vibrante y experiencias únicas te esperan. Desde las
              cumbres de los Andes hasta las playas del Caribe, cada rincón es
        ...
        <div className="col-span-5 flex flex-col items-center justify-center xl:m-10">
          <h2 className="xl:text-5xl text-4xl font-bold text-scuba_blue mb-3 justify-center">
            Sobre Nosotros
          </h2>
          <p className="text-azul_o text-lg m-12 text-center">
            En{" "}
            <span className="text-[20px] text-mostaza font-bold text-center">
              DAZA TOURS
            </span>
            , nuestra misión es hacer que cada viaje sea una experiencia
            inolvidable. Nos dedicamos a brindar momentos únicos y auténticos en
            los destinos más hermosos de Colombia. Nuestro equipo está
            comprometido a ofrecer un servicio excepcional, basado en nuestros
            valores de pasión, profesionalismo y dedicación.
          </p>
          <Caras />
        </div>
      </section>
